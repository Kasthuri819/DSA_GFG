...
class Solution
{
    ...
    static ArrayList <Integer> verticalOrder(Node root)
    {
        ...
        Map<Integer, Map<Integer, LinkedList<Integer>>> nodes = new TreeMap<>();
        ...
        while (!queue.isEmpty()) {
            ...
            int x = pair.getValue().getKey();  // Vertical
            int y = pair.getValue().getValue();  // Level
        ...
        for (Map.Entry<Integer, Map<Integer, LinkedList<Integer>>> entry : nodes.entrySet()) {
            for (LinkedList<Integer> list : entry.getValue().values()) {
                ans.addAll(list); 
            }
        }
